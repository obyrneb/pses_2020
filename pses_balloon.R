...
demq_exclude <- c(
  ...
  "Q85", # Managed remote workers
  "Q100", # Shift worker
  "Q101", # Full- or part-time
  "Q107", # Professioanl community
  "Q111", # Serve the public
  "Q113" # Work in a bilinguial area
  )
...
bp <- ggplot(
  ...
  labs(
    title = "PSES@TBS 2019 - sentiment by Question and Demographic",
...
bp_plotly <- ggplotly(bp, tooltip = c("text")) %>% 
  layout(title = list(text = paste0(
    'PSES@GAC 2020 - sentiment by Question and Demographic',
    '<br>',
    '<sup>',
...
htmlwidgets::saveWidget(as_widget(bp_plotly), file.path(plot_dir,"ChiSquare_BalloonChart_PSES2020_GAC.html"))
