...
sector_list <- c(315, 301, 322, 323, 302, 303, 304, 305,
...
for (this_unitcode in sector_list) {
  ...
  other_sectors <- c(e = "Other Sectors",
                     f = "Autres secteurs")
  ttl <- c(e = paste0("PSES 2018 - Comparison of ",this_sector[["e"]]," and ",dept[["e"]]),
           f = paste0("SAFF 2018 - Comparaison de ",this_sector[["f"]]," et ",dept[["f"]]))
  ...
  y_dim <- c(e = "Score 100",
             f = "Score 100")
  filename <- c(e = paste0("PSES2018@",this_dept_e,
                           " - Sector Line Chart - ",
                           this_unitcode," - ",
                           str_replace_all(this_sector[[lang]], "\\\\|/", ";"),
                           ".svg"),
                f = paste0("SAFF2018@",this_dept_f,
  ...
  line_plot <- ggplot(sector_qs, aes(x = QUESTION, y = SCORE100)) +
    ...
    theme_classic() +
    theme(legend.position = "top",#c(.105,.35),
  ...
  ggsave(file.path(mainDir,plotDir,filename[[lang]]),
